...
class TestLambdaHandler:
    ...
    def test_lambda_handler_success(self, mock_logger, mock_notify_parser, mock_persist_to_s3, mock_fetch_data, mock_get_earliest_unfetched_date, mock_insert_fetch_status, mock_database, mock_get_config, mock_calculate_from_date, mock_log_initial_info):
    ...
    @patch('services.fetch_daily_summaries.src.fetch_daily_summaries.notify_parser')
    @patch('services.fetch_daily_summaries.src.fetch_daily_summaries.logger')
    def test_lambda_handler_exception(self, mock_logger, mock_notify_parser, mock_persist_to_s3, mock_fetch_data, mock_get_earliest_unfetched_date, mock_insert_fetch_status, mock_database, mock_get_config, mock_calculate_from_date, mock_log_initial_info):
