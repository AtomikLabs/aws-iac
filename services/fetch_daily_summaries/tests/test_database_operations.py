...
class TestInsertFetchStatus(unittest.TestCase):
    ...
    def test_successful_insert(self, mock_boto3_client):
        ...
        response = insert_fetch_status(date(2023, 1, 1), "mock_aurora_arn", "mock_secret_arn", "mock_database")
    ...
    def test_exception_on_insert(self, mock_boto3_client):
        ...
        with self.assertRaises(Exception) as context:
            insert_fetch_status(date(2023, 1, 1), "mock_aurora_arn", "mock_secret_arn", "mock_database")
...
class TestSetFetchStatus(unittest.TestCase):
    ...
    def test_set_fetch_status_success(self, mock_boto3_client):
        ...
        result = set_fetch_status(test_date, status, aurora_cluster_arn, db_credentials_secret_arn, database)
