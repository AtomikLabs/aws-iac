...
from services.services_layer.src.services_layer.utils import (
    DEFAULT_TIMEZONE,
...
@patch("services.services_layer.src.services_layer.utils.datetime")
...
def test_get_storage_key_datetime_without_date_str():
    ...
    with patch("services.services_layer.src.services_layer.utils.datetime") as mock_datetime:
