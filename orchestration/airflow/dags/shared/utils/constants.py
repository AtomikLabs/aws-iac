...
# Schemas
ARXIV_RESEARCH_INGESTION_EVENT_SCHEMA = "arxiv_research-ingestion-event-schema"
COMPLETED = "COMPLETED"
FAILED = "FAILED"
...
DATA_ARXIV_SUMMARIES_INGESTION_COMPLETE_TOPIC = "DATA_ARXIV_SUMMARIES_INGESTION_COMPLETE_TOPIC"
